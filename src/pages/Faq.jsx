        ...
        <section className="py-10 bg-gray-50 sm:py-16 lg:py-24" id='faq'>
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="max-w-2xl mx-auto text-center">
                    ...
                    <p className="max-w-xl mx-auto mt-4 text-sm md:text-base leading-relaxed text-gray-600">From Concept to Code – I Build Projects That Shine!</p>
                </div>
                    ...
                    {faq.map((item, index) => (
                        <div key={index} className="transition-all duration-200 bg-white border border-gray-200 cursor-pointer hover:bg-gray-50">
                            <button type="button" className="flex items-center justify-between w-full px-4 py-5 sm:p-6" onClick={() => toggleFaq(index)}>
                                <span className="flex md:text-lg text-base text-left font-semibold text-black"> {item.question} </span>
                ...
                <p className="text-center text-gray-600 textbase mt-9" id='contact'>Didn’t find the answer you are looking for? <a href="tel:+1234567890" title="" className="font-medium text-blue-600 transition-all duration-200 hover:text-blue-700 focus:text-blue-700 hover:underline">Contact me</a></p>
            </div>
        </section>
    );
}
