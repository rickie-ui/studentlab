    ...
    <header className="relative py-4 md:py-6">
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto text-center">
                ...
                <p className="mt-8 text-base text-gray-500 font-inter">Need help coding your student project? I specialize in turning your ideas into fully functional applications, ensuring they are well-structured, optimized, and ready to impress.</p>
            </div>
        </div>
